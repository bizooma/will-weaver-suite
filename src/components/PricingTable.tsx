...
const plans = [
  ...
  },
  {
    ...
    icon: Star,
    popular: false,
    priceId: "price_standard_monthly" // You'll need to create this in Stripe
  },
  {
    name: "Pro PI", 
    price: "$3,500",
    ...
    icon: Zap,
    popular: false,
    priceId: "price_pro_pi_monthly" // You'll need to create this in Stripe
  },
  {
    name: "Pro Estate",
    price: "$4,500", 
    ...
    icon: Crown,
    popular: true,
    priceId: "price_pro_estate_monthly" // You'll need to create this in Stripe
  }
];
